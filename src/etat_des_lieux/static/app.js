...
const translations = {
  ...
  fr: {
    ...
    "nav.quality": "Qualité",
    "nav.pilot": "Pilot",
    "hero.eyebrow": "Pour les rapports d'expertise",
    "hero.title": "Vos enregistrements deviennent des documents clients.",
    "hero.lead":
      "Notre IA agentique automatise la rédaction, du compte rendu oral de l'expert au document structuré prêt à envoyer.",
    ...
    "workflow.title": "Finie la rédaction manuelle après chaque visite.",
    ...
    "workflow.card2.text": "Des agents IA transcrivent, nettoient, organisent, évaluent et révisent le rapport.",
    ...
    "quality.text":
      "Ce n'est pas une simple transcription. Le rapport est rédigé, évalué puis révisé à partir de l'enregistrement original.",
    ...
    "pilot.title": "Envoyez un audio et un modèle.",
    ...
    "pilot.send.item3": "Les règles de mise en forme à respecter",
    "pilot.back.title": "Ce que vous recevez",
    "pilot.back.text":
      "Un document exemple dans votre structure, prêt à relire, livré sous 2 heures pendant les heures ouvrables.",
