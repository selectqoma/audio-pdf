...
const translations = {
  en: {
    ...
    "solution.copy":
      "Voice2Doc transcribes the inspection recording, detects rooms and observations, extracts damages and remarks, and generates a report in your existing Word template.",
    ...
    "review.copy":
      "The goal is not to force your team to reread every line. Voice2Doc highlights uncertain or risky items, such as unclear audio, ambiguous damage descriptions, missing information, low-confidence sections, or unusual observations.",
    ...
    "workflow.step3": "Voice2Doc extracts rooms, components, damages, and remarks",
    ...
    "template.copy":
      "Voice2Doc is adapted to your current report template, phrasing, room order, and recurring clauses. Your experts do not need to change the way reports are delivered.",
    ...
    "faq.a1": "No. Voice2Doc generates a structured draft and highlights uncertain items. A human reviewer validates the final report.",
    ...
    "final.copy":
      "Test Voice2Doc with one anonymized inspection recording and compare the generated draft with your current process.",
  ...
  fr: {
    ...
    "solution.copy":
      "Voice2Doc transcrit l'enregistrement, détecte les pièces et observations, extrait les dégâts et remarques, puis génère un rapport dans votre modèle Word existant.",
    ...
    "review.copy":
      "L'objectif n'est pas d'obliger votre équipe à relire chaque ligne. Voice2Doc met en évidence les points incertains ou à risque : audio peu clair, description ambiguë d'un dégât, information manquante, section à faible confiance ou observation inhabituelle.",
    ...
    "workflow.step3": "Voice2Doc extrait pièces, éléments, dégâts et remarques",
    ...
    "template.copy":
      "Voice2Doc s'adapte à votre modèle, vos formulations, l'ordre des pièces et vos clauses récurrentes. Vos experts ne changent pas la façon dont les rapports sont livrés.",
    ...
    "faq.a1": "Non. Voice2Doc génère un brouillon structuré et signale les points incertains. Un relecteur humain valide le rapport final.",
    ...
    "final.copy":
      "Testez Voice2Doc avec un enregistrement anonymisé et comparez le brouillon généré à votre processus actuel.",
  ...
  nl: {
    ...
    "solution.copy":
      "Voice2Doc transcribeert de inspectie-opname, detecteert kamers en observaties, haalt schade en opmerkingen op, en genereert een rapport in jullie bestaande Word-template.",
    ...
    "review.copy":
      "Het doel is niet dat jullie team elke regel opnieuw moet lezen. Voice2Doc markeert onzekere of risicovolle punten, zoals onduidelijke audio, ambigue schadebeschrijvingen, ontbrekende informatie, lage betrouwbaarheid of ongewone observaties.",
    ...
    "workflow.step3": "Voice2Doc haalt kamers, onderdelen, schade en opmerkingen op",
    ...
    "template.copy":
      "Voice2Doc wordt aangepast aan jullie huidige template, formuleringen, kamervolgorde en terugkerende clausules. Experts hoeven de manier van rapporteren niet te veranderen.",
    ...
    "faq.a1": "Nee. Voice2Doc genereert een gestructureerde draft en markeert onzekere punten. Een menselijke reviewer valideert het eindrapport.",
    ...
    "final.copy":
      "Test Voice2Doc met een geanonimiseerde inspectie-opname en vergelijk de gegenereerde draft met jullie huidige proces.",
